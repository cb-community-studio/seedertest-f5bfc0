...
import SeedersPage from "../components/SeedersPage/SeedersPage";
import SingleSeedersPage from "../components/SeedersPage/SingleSeedersPage";
// ~cb-add-import~
        ...
        <div className={wrapperClass} onClick={onWrapperClick}>
            ...
            <MainLayout>
                <Switch>
                    ...
                    <Route path="/seeders" component={SeedersPage} exact />
                    <Route path="/seeders/:singleSeedersId" component={SingleSeedersPage} exact />
                    {/* ~cb-add-route~ */}
